...
;; Replace procedual representation of a Bounce by a data structure representation.
...
(define trampoline
  (lambda (a-bounce)
    (begin
      ...
      (if (expval? a-bounce)
          a-bounce
          (cases bounce a-bounce
            (internal-answer (body env cont)
                             (value-of/k body env cont))
            (else (eopl:printf "trampoline error!\n")))))))
