...
(define cont->readable
  (lambda (cont)
    (eopl:printf
     (cases continuation cont
       (end-cont () "end-cont\n")
       (zero1-cont (saved-cont) "zero1-cont\n")
       (let-exp-cont (var body saved-env saved-cont) "let-exp-cont\n")
       (if-test-cont (exp2 exp3 saved-env saved-cont) "if-test-cont\n")
       (diff1-cont (exp2 saved-env saved-cont) "diff1-cont\n")
       (diff2-cont (val1 saved-cont) "diff2-cont\n")
       (rator-cont (rand saved-env saved-cont) "rator-cont\n")
       (rand-cont (val1 saved-cont) "rand-cont\n")
       (else "other-cont\n")))))
