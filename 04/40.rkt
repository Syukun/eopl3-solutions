#lang eopl
;; Modify value-of-oprand so that it avoids making thunks for constants and procedures.
...
(define (extend-env-list var-list val-list env)
  (if (null? var-list) env
      (extend-env-list (cdr var-list)
                       (cdr val-list)
                       (extend-env (car var-list) (newref (car val-list)) env)))) 
