...
;; about list,I have to say something.
;; as we can see, procedure (scan&parse "list (1, 2, 3)") produces
;; (a-program (list-exp ((const-exp 1) (const-exp 2) (const-exp 3))))
;; That is to say that,in there args is actually a list, we can verify args use a procedure (list-of expression?)
;; fantastic!
