...
;; 题目的要求是扩展checker,使得checker可以处理多重let表达式,多参数的函数,多个letrec的声明
...
(define type-of
  (lambda (exp tenv)
    (cases expression exp
      ...
      ;; if ty1 is not a bool-type, ignore check ty2 equal ty3
	   ;; anyway return ty2, assume a non-boolean type stands for true
	   ;; for if-exp
...
;; test code
(type-of-program (scan&parse "if 1 then 1 else 2"))
