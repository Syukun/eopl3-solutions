...
class sum_list extends object implements summable
...
class leaf_node extends object implements summable
 field int value
  method void initialize(v : int) set value = v
  method int sum() value

class interior_node extends object implements object % 内部的节点
 field summable left
 field summable right
 method void initialize (l: summable, r : summbale)
  begin
   set left = l;
   set right = r;
  end
...
class general_tree extends object implements summable
 field sum_list left
