...
(define check-field-and-types!
  (lambda (types exps)
    (if (null? types) #t
        (begin
          (check-is-subtype! (car types) (type-of (car exps) (empty-tenv)) (car exps))
          (check-field-and-types! (cdr types) (cdr exps))))))
  ...
  (lambda (c-decl)
    (cases class-decl c-decl
           ...
           (a-class-decl (class-name super-name i-names
                                     field-types field-names field-exps method-decls) ;; 这里是类的定义
                         (check-field-and-types! field-types field-exps)
  ...
  (lambda (c-decl)
    (cases class-decl c-decl
           ...
           (a-class-decl (c-name s-name i-names
                                 f-types f-names f-exps m-decls) ;; 类的定义
                         (let ((i-names
                                (append
                                 (static-class->interface-names
...
(define initialize-class-decl!
  (lambda (c-decl)
    (cases class-decl c-decl
           ...
           (a-class-decl (class-name super-name interface-names field-types field-names f-exps method-decls)
                         (let ((field-names
                                (append-field-names
